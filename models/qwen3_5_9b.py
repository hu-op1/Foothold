...
docstring for the full op breakdown; dims verified against the
Qwen/Qwen3.5-9B config.json (hidden 4096, 16 q / 4 kv heads, head_dim 256,
intermediate 12288, linear key 16×128 / value 32×128, conv kernel 4,
